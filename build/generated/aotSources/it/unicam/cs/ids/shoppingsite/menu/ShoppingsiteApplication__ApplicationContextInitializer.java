 ...
 */
public class ShoppingsiteApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new ShoppingsiteApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new ShoppingsiteApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
